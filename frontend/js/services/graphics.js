(function () {
  ...
  function graphics() {
    ...
    function drawRoads(roadGraphs) {
      var roadIds = Object.keys(roadGraphs);

      for (var index = 0; index < roadIds.length; index++) {
        var pointsArray = [],
            linesArray = [];

        console.log('Drawing road ' + index);

        roadId = roadIds[index];

        console.log(roadIds[index]);
        ...
        console.log(roadGraphs[roadId].edges);
        ...
        if (linesArray.length) {
...

          {
            ...
            console.log(roadGraphs[roadId].color);
